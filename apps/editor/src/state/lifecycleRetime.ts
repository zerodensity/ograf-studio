...
export function lifecycleRetimeBounds(
  ...
  // Imported documents may contain zero-duration adjacent transitions. Until those transitions
  // are expanded, there is no legal one-frame slot in which to move this marker.
